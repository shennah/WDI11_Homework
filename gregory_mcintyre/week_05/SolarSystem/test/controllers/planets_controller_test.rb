...
class PlanetsControllerTest < ActionController::TestCase
  ...
  test "should create planet" do
    assert_difference('Planet.count') do
      post :create, planet: { image: @planet.image, mass: @planet.mass, mean_radius: @planet.mean_radius, name: @planet.name, num_moons: @planet.num_moons }
    end
  ...
  test "should update planet" do
    patch :update, id: @planet, planet: { image: @planet.image, mass: @planet.mass, mean_radius: @planet.mean_radius, name: @planet.name, num_moons: @planet.num_moons }
    assert_redirected_to planet_path(assigns(:planet))
  end
